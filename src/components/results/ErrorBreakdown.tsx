  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2">
      {missedChars.length > 0 && (
        <div className="bg-white p-4 shadow-[0_8px_20px_-12px_rgba(23,24,28,0.35)]">
          <h3 className="mb-3 text-[13px] font-bold text-board uppercase tracking-wide">
            Most missed keys
          </h3>
            ...
            {categoryErrors.slice(0, 5).map((c) => {
              ...
              return (
                <div key={c.category} className="flex items-center gap-3">
                  <span className="w-28 shrink-0 font-mono text-xs font-bold text-board">
