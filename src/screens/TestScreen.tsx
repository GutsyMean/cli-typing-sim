...
export function TestScreen({
  ...
  return (
    <div className="mx-auto w-full max-w-4xl">
        ...
        <AnimatePresence>
          {capsLock && (
            <motion.span
              ...
              exit={{ opacity: 0, y: 4 }}
              className="rounded-[3px] px-3 py-1 text-sm font-bold tracking-[0.08em] uppercase shadow-[0_0_18px_-2px_var(--w-stop)]"
      ...
      {isTouchDevice && (
        <p className="mt-4 text-center text-sm text-legend-dim">
